...
class SportToolbarScrollBehavior(
    val state: SportToolbarScrollState,
...
private suspend fun snapToolbar(state: SportToolbarScrollState) {
...
@Composable
fun rememberToolbarScrollBehavior() = SportToolbarScrollBehavior(
